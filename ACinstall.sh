...
# Create the database
mysql -h localhost -P 3306 -S /tmp/mysqld.sock -u root -p"$ROOT_PASSWORD" -e "CREATE DATABASE IF NOT EXISTS acore_characters;"
mysql -h localhost -P 3306 -S /tmp/mysqld.sock -u root -p"$ROOT_PASSWORD" -e "CREATE DATABASE IF NOT EXISTS acore_auth;"
mysql -h localhost -P 3306 -S /tmp/mysqld.sock -u root -p"$ROOT_PASSWORD" -e "CREATE DATABASE IF NOT EXISTS acore_world;"
msg "$GREEN" "Created acore databases."

# Import SQL files for DB creation
msg "$YELLOW" "Importing SQL files..."
mysql -h localhost -P 3306 -S /tmp/mysqld.sock -u root -p"$ROOT_PASSWORD" acore_auth < ../sql/auth/auth_full.sql
mysql -h localhost -P 3306 -S /tmp/mysqld.sock -u root -p"$ROOT_PASSWORD" acore_world < ../sql/world/world_full.sql
mysql -h localhost -P 3306 -S /tmp/mysqld.sock -u root -p"$ROOT_PASSWORD" acore_characters < ../sql/characters/characters_full.sql
...
mysql -h localhost -P 3306 -S /tmp/mysqld.sock -u root -p"$ROOT_PASSWORD" << EOF
use acore_auth;
